...
<!DOCTYPE html>
<head>
<title>MangoBD| Admin-panel: Home-page</title>
...
<!--logo start-->
<div class="brand">
    <a href="master.blade.php" class="logo">
        VISITORS
    </a>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('front/images/2.png')}}"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('front/images/profile.png')}}">
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="master.blade.php">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Manage Category</a></li>
						<li><a href="glyphicon.html">Add New</a></li>
                    </ul>
                </li>
                <li>
...
<script src="{{asset('dashboard/js/jquery.scrollTo.js')}}"></script>
