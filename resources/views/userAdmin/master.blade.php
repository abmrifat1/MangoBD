...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('userAdmin/css/cs-skin-elastic.css') }}">
    <link rel="stylesheet" href="{{ asset('userAdmin/css/style.css') }}">
...
--}}
                ...
                <li>
                    <a href="/profile" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Profile</a>
                    {{--<ul class="sub-menu children dropdown-menu">
                ...
                <div class="header-left">
                   ...
                   {{-- <div class="dropdown for-message">
                        ...
                        <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{ asset('userAdmin/images/avatar/1.jpg') }}"></span>
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="{{ asset('userAdmin/images/avatar/2.jpg') }}"></span>
                                <div class="message media-body">
...
<!-- Footer -->
    <footer class="site-footer">
        <div class="footer-inner bg-white">
            <div class="row">
                <div class="col-sm-6">
                    Copyright &copy; 2019 EM Admin
                </div>
                <div class="col-sm-6 text-right">
                    Designed by <a href="https://colorlib.com">Emamul</a>
                </div>
            </div>
        </div>
    </footer>
...
<script src="{{ asset('userAdmin/js/main.js') }}"></script>
...
<script src="{{ asset('userAdmin/js/init/weather-init.js') }}"></script>

<script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
<script src="{{ asset('userAdmin/js/init/fullcalendar-init.js') }}"></script>
