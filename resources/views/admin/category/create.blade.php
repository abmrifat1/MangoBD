        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'admin/category','method'=>'POST','files' => true,'class'=>'form-horizontal form-label-left']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            {!! Form::label('isActive','Publication Status ',['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!!  Form::select('isActive', ['Active' => 'Publish', 'DeActive' => 'Draft'], 1, ['class'=>'form-control','id'=>'isActive'])!!}
                            </div>
                        </div>
