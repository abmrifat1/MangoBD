                            ...
                            @php($i=0)
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="{{ url('/admin/category/'.$category->unique_id) }}" title="Un Publish" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                            ...
                                            {!! Form::open(['url' => '/admin/category/'.$category->unique_id,'method'=>'DELETE','style'=>'display:inline']) !!}
