    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Portfolio Update Registration Form</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'dashboard/portfolio/update/'.$portfolio->unique_id,'method'=>'PATCH','files' => true,'class'=>'form-horizontal form-label-left']) !!}


                        <div class="item form-group">
                            {!! Form::label('item_name','Item Name *',['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('item_name',$portfolio->item_name,['class'=>'form-control col-md-7 col-xs-12','id'=>'item_name','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('title',$portfolio->title,['class'=>'form-control col-md-7 col-xs-12','id'=>'title','required'=>'required']) !!}
                                @if ($errors->has('title'))
                                    <span class="help-block error">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::hidden('previousImageUrl',$portfolio->image) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::hidden('previousImageUrl_two',$portfolio->image_two) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('portfolio_content',$portfolio->portfolio_content,['class'=>'form-control col-md-7 col-xs-12','id'=>'portfolio_content','required'=>'required']) !!}
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="category_id" id="category_id" class="form-control col-md-7 col-xs-12">
                                    @foreach($portfolio_categories as $portfolio_category)
                                        <option value="{{$portfolio_category->unique_id}}" {{$portfolio->category_id==$portfolio_category->unique_id ? 'selected':''}}>{{$portfolio_category->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('demo_url',$portfolio->demo_url,['class'=>'form-control col-md-7 col-xs-12','id'=>'demo_url']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!!  Form::select('status', ['1' => 'Publish', '0' => 'UnPublish'], $portfolio->status, ['class'=>'form-control','id'=>'status'])!!}
                            </div>
                        </div>
