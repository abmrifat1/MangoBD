        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'dashboard/team/store','method'=>'POST','files' => true,'class'=>'form-horizontal form-label-left']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('website_url',null,['placeholder'=>'https://www.facebook.com/','class'=>'form-control col-md-7 col-xs-12','id'=>'website_url']) !!}
