    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Testimonial Registration Form</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'dashboard/testimonial/store','method'=>'POST','files' => true,'class'=>'form-horizontal form-label-left']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('designation',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'designation','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <span>Image will be 100x100</span>
                                @if ($errors->has('image'))
                                    <span class="help-block error">
