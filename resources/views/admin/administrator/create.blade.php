        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'dashboard/administrator/store','method'=>'POST','files' => true,'class'=>'form-horizontal form-label-left']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::number('age',null,['min'=>1,'class'=>'form-control col-md-7 col-xs-12','id'=>'age','required'=>'required']) !!}
                                @if ($errors->has('age'))
                                    <span class="help-block error">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('email',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'email','required'=>'required']) !!}
                                @if ($errors->has('email'))
                                    <span class="help-block error">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('phone_two',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'phone_two','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('city',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'city','required'=>'required']) !!}
                                @if ($errors->has('city'))
                                    <span class="help-block error">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('country',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'country','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('address',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'address','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::file('resume',['class'=>'form-control col-md-7 col-xs-12','id'=>'resume','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('story_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'story_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('skill_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'skill_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('experience_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'experience_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('education_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'education_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('our_team_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'our_team_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('testimonial_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'testimonial_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('blog_content',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'blog_content','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('website_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'website_link','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('facebook_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'facebook_link']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('twitter_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'twitter_link']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('google_plus_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'google_plus_link']) !!}
                       ...
                       <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('linkedin_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'linkedin_link']) !!}
                       ...
                       <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('pinterest_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'pinterest_link']) !!}
                       ...
                       <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('dribble_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'dribble_link']) !!}
                       ...
                       <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('behance_link',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'behance_link']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!!  Form::select('status', ['0' => 'Un Publish'], 0, ['class'=>'form-control','id'=>'status'])!!}
                            </div>
                        </div>
