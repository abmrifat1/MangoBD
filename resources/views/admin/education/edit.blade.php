        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['url' => 'dashboard/education/update/'.$education->unique_id,'method'=>'PATCH','files' => true,'class'=>'form-horizontal form-label-left']) !!}


                        <div class="item form-group">
                            {!! Form::label('degree_name','Degree Name *',['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('degree_name',$education->degree_name,['class'=>'form-control col-md-7 col-xs-12','id'=>'degree_name','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::text('institute_name',$education->institute_name,['class'=>'form-control col-md-7 col-xs-12','id'=>'institute_name','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{Form::hidden('previousImageUrl',$education->image)}}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::textarea('comment',$education->comment,['class'=>'form-control col-md-7 col-xs-12','id'=>'comment','required'=>'required']) !!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="starting_year" id="" class="form-control col-md-7 col-xs-12">
                                    @for($i=2017;$i>1990;$i--)
                                        <option value="{{$i}}" {{$education->starting_year==$i?'selected':''}}>{{$i}}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="ending_year" id="" class="form-control col-md-7 col-xs-12">
                                    @for($i=2025;$i>1990;$i--)
                                        <option value="{{$i}}" {{$education->ending_year==$i?'selected':''}}>{{$i}}</option>
                                    @endfor
                                </select>
                            </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {!!  Form::select('status', ['1' => 'Publish', '0' => 'UnPublish'], $education->status, ['class'=>'form-control','id'=>'status'])!!}
                            </div>
                        </div>
