...
<head>
    <title>Shipping Info Page :: MangoBD</title>
{{ Session::put('page', 'shippingInfo') }}
    <!--/tags -->
...
<div class="content">
    <div class="new-arrivals-w3agile">
        <div class="container" id="backcolor">
            <!-- tittle heading -->
            <div style="background: white; border: grey 2px; height: auto; margin-bottom: 20px; border-radius: 5px;">
                <h2 style="text-align: center; padding-top: 15px; padding-bottom: 20px; font-size: 20px; color: green;">Welcome {{ $customer->first_name.' '.$customer->last_name }}. You have to give shipping information to complete your valuable order.
                    If your billing and shipping info is same then just press on save shipping info button.</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="panel-body">
                        <h1 class="text-success text-center">Shipping Information</h1>
                        <hr>
                        <form class="form-horizontal" action="{{ url('/new-shipping') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="full_name" value="{{ $customer->first_name.' '.$customer->last_name }}" class="form-control" required/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="address" style="resize: vertical;" required>{{ $customer->address }}</textarea>
