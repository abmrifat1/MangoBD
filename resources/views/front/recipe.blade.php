	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Ripe Mango
			...
			<div class="side-bar col-md-3">
				...
				<!-- food preference -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Raw | Ripe Mango</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Raw</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Ripe</span>
						</li>
					</ul>
				</div>
				<!-- //food preference -->
